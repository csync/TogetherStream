...
bot.streamPrefix = "streams.bot123";
    ...
    fetchVideoInfo(videoID)
        .then(function (videoInfo) {
            ...
            if(videoInfo.items.length == 0) {
                console.error("Error receiving video info for video with ID: " + videoID);
                // Skip to next video
                streamPlaylist();
            }
            else {
...
let playVideo = function (videoId, duration) {
    ...
    setTimeout(function () {
        console.log("Playing video with ID: " + videoId + " for a duration of " + duration + " seconds");
