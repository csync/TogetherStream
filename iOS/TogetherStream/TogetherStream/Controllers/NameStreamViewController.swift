...
class NameStreamViewController: UIViewController {
    ...
    private func setupTextFields() {
        ...
        descriptionTextView.textColor = UIColor.togetherStreamPlaceholderGray
...
extension NameStreamViewController: UITextViewDelegate {
    ...
    func textViewDidBeginEditing(_ textView: UITextView) {
        if isDescriptionPlaceholder {
            textView.text = nil
            textView.textColor = UIColor.togetherStreamTextBlack
        }
    }
    ...
    func textViewDidEndEditing(_ textView: UITextView) {
        if textView.text.isEmpty {
            ...
            textView.textColor = UIColor.togetherStreamPlaceholderGray
        }
    }
}
